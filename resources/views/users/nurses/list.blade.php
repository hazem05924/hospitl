...
@section('content')
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">قائمة الممرضين</h3>
        ...
        <!-- begin:: Container -->
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid ؤخم-12">
            <!-- begin:: Alert -->
                        ...
                        <tbody>
                            @foreach ($nurses as $nurse)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('nurses.edit', $nurse->id) }}" method="post">
                                            @method('get')
                                            @csrf
