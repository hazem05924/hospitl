        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">قائمة تذاكر الدخول</h3>
                        ...
                        <tbody>
                            @foreach ($accountants as $accountant)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('accountants.edit', $accountant->id) }}" method="post">
                                            @method('get')
                                            @csrf
                                    ...
                                    <td>
                                        <form action="{{ route('accountants.destroy', $accountant->id) }}"
                                            method="post">
                                            @method('DELETE')
                                            @csrf
                                    ...
                                    <td>
                                        <form action="{{ route('accountants.show', $accountant->id) }}" method="post">
                                            @method('get')
                                            @csrf
