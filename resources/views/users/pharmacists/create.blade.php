        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">{{ isset($pharmacist) ? 'تعديل بيانات الصيدلي' : 'إضافة صيدلي' }}</h3>
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="address" id="address" cols="30" rows="5">{{ isset($pharmacist) ? $pharmacist->address : '' }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>الإيميل</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="gender" id="gender">
                                            ...
                                            <option value="male"
                                                @if (isset($pharmacist)) {{ $pharmacist->gender == 'male' ? 'selected' : '' }} @endif>
                                                ذكر
                                            </option>
                                            <option value="female"
                                                @if (isset($pharmacist)) {{ $pharmacist->gender == 'female' ? 'selected' : '' }} @endif>
                                                أنثى
                                            </option>
                                        </select>
                                    </div>
                                        ...
                                        <select id="kt_select2_3" class="kt-select form-control" name="departments[]"
                                            ...
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->id }}"
                                                    @if (isset($pharmacist)) {{ $pharmacist->hasDepartment($department->id) ? 'selected' : '' }} @endif>
                                                    {{ $department->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="kt-portlet__foot  d-flex flex-row-reverse">
                                    <div class="kt-form__actions">
                                        <input type="submit" value="{{ isset($pharmacist) ? 'تحديث' : 'حفظ' }}"
