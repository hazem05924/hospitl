                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            {{ isset($department) ? 'تعديل معلومات القسم' : 'إضافة قسم' }}
                        </h3>
                    </div>
                    <div class="form-group form-group-last">
                        <div class="alert alert-secondary" role="alert">
                            ...
                            <div class="alert-text">
                                {{ isset($department) ? 'نموذج تعديل معلومات القسم' : 'نموذج إضافة قسم' }}
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="description" id="description" cols="30" rows="5">{{ isset($department) ? $department->description : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="kt-portlet__foot  d-flex flex-row-reverse">
                                <div class="kt-form__actions">
                                    <input type="submit" value="{{ isset($department) ? 'تحديث' : 'حفظ' }}"
