        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">قائمة الوثائق</h3>
                        ...
                        <tbody>
                            @foreach ($documents as $document)
                                <tr>
                                    ...
                                    <td>{{ $document->doc }}</td>
                                    <td>
                                        <form action="{{ route('documents.edit', $document->id) }}" method="post">
                                            @method('get')
                                            @csrf
                                    ...
                                    <td>
                                        <form action="{{ route('documents.destroy', $document->id) }}"
                                            ...
                                            @method('DELETE')
                                            @csrf
                                            <button type="submit" class="btn btn-danger btn-md"> حذف <i
