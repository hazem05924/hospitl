            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">
                        {{ isset($category) ? 'تعديل بيانات نوع الدواء' : 'إضافة نوع دواء' }}
                    </h3>
                            ...
                            <div class="kt-portlet__body">
                                <div class="form-group form-group-last">
                                    <div class="alert alert-secondary" role="alert">
                                        ...
                                        <div class="alert-text">
                                            يمكنك إضافة نوع دواء جديد من هنا.
                                        </div>
                                    </div>
                                </div>
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="description" id="description" cols="30" rows="5">{{ isset($category) ? $category->description : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="kt-portlet__foot d-flex flex-row-reverse">
                                <div class="kt-form__actions">
                                    <input type="submit" value="{{ isset($category) ? 'تحديث' : 'حفظ' }}"
