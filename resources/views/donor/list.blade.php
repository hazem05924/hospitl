        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">عرض التبرعات</h3>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('donor.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                                    ...
                                    <td>
                                        <span class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{ route('donor.edit', $donor->id) }}">
                                                    تعديل <i class="fa fa-edit" aria-hidden="true"></i></button>
                                                </a>
                                                <a href="{{ route('donor.show', $donor->id) }}" class="dropdown-item">
                                                    حذف <i class="fa fa-trash" aria-hidden="true"></i></button>
                                                </a>
                                            </div>
                                        </span>
                                    </td>
