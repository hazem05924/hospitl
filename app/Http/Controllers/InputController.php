...
class PatientController extends Controller
{
    ...
    {
        return view('users.input.list')->with('input', User::Input()->get())->with('departments',Department::all());
    }

    public function create()
    {
        return view('users.input.create')->with('departments',Department::all());
    }
    ...
    {
        return view('users.input.create')
    ...
    public function update(Request $request, User $patient)
    {
        ...
        if ($request->hasFile('picture')) {
            $pic = $request->picture->store('input_pictures');
