...
class NurseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // flash message
        session()->flash('success', 'تم إضافة الممرض/ة بنجاح.');
        // redirect user
    ...
    {
        return view('users.nurses.create')
        ->with('nurse', $nurse)
        ->with('departments', Department::all());
    }
    ...
    {
        $data = $request->only('first_name', 'last_name', 'national_id', 'email', 
        'address', 'birth_date', 'gender', 'phone', 'mobile', 'emergency');
